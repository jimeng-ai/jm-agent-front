...
export const WORKBENCH_NAV: NavItem[] = [
  ...
  { key: 'chat', label: '对话', path: '/chat', Icon: SparklesIcon },
  { key: 'agents', label: 'Agents', path: '/console/agents', Icon: AgentIcon },
  { key: 'knowledge', label: '知识库', path: '/console/knowledge', Icon: BookIcon },
  { key: 'plugins', label: '插件', path: '/console/plugins', Icon: PlugIcon },
];

export const DEBUG_NAV: NavItem[] = [
  { key: 'playground', label: '调试 Playground', path: '/console/playground', Icon: PlayIcon },
];
